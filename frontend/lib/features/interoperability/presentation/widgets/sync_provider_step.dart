...
class SyncProviderStep extends StatelessWidget {
  const SyncProviderStep({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    if (errorMessage != null) {
      return _StateCard(
        ...
        title: 'Provider list unavailable',
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          'Choose the hospital or clinic where you want to sync records from.',
        ...
        BottomSheetSelectFormField<String>(
          ...
          helperText: 'Only active providers are available for sync.',
        ),
      ],
    );
  }
